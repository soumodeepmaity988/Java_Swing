...
class RegistrationForm_With_JTable{
    public static void main(String[]args){
        JFrame frame=new JFrame();
        frame.setBounds(60,30,1800,1000);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        Container c=frame.getContentPane();
        c.setBackground(new Color(255, 255, 102));
        c.setLayout(null);
        ComponentsOfFormJTable componentsOfFormJTable=new ComponentsOfFormJTable(c,frame);
        frame.setVisible(true);
    }
}
class ComponentsOfFormJTable implements ActionListener {
    ...
    JTable table;
    String[] columnName;
    ComponentsOfFormJTable(Container c,JFrame frame){
        ...
        arr= new Object[][]{{1, "saikat", 101},{2, "Ram", 102},{3, "Manna", 103},{4, "Shalmoli", 104},{5, "Diptaru", 105}};
        columnName=new String[]{"id","Name","Roll no."};
        JTable table=createJTable(c,frame);
    }

    public JTable createJTable(Container c,JFrame frame){
        DefaultTableModel tableModel=new DefaultTableModel(arr,columnName);
        JTable table=new JTable(tableModel);
        table.setBounds(10,197,500,500);
